    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      {showForm && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 md:p-6 print:hidden">
          ...
          <div className="relative w-full max-w-5xl bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-zinc-200 dark:border-zinc-800">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {saleItems.map((item, idx) => {
                    ...
                    return (
                      <div key={item.id} className="p-6 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm grid grid-cols-1 md:grid-cols-12 gap-4 items-end relative group hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
                        <div className="md:col-span-2">
                          ...
                          <select 
                            ...
                            onChange={(e) => updateItem(item.id, { wood_type: e.target.value, length: 0, condition: '', diameter_group: '' })}
                          >
                        ...
                        <div className="md:col-span-1">
                          ...
                          <select 
                            className="input-field w-full dark:bg-zinc-900 dark:text-white"
                            value={item.length || ''}
                            onChange={(e) => updateItem(item.id, { length: e.target.value, condition: '', diameter_group: '' })}
                        ...
                        <div className="md:col-span-2">
                          ...
                          <select 
                            ...
                            onChange={(e) => updateItem(item.id, { condition: e.target.value, diameter_group: '' })}
                        ...
                        <div className="md:col-span-2">
                          ...
                          <select 
                            ...
                            onChange={(e) => updateItem(item.id, { diameter_group: e.target.value })}
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input 
                            ...
                            placeholder="0.000"
                            value={item.volume || ''}
                            onChange={(e) => updateItem(item.id, { volume: Math.max(0, parseFloat(e.target.value) || 0) })}
                          />
                          {selectedInv && (
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="relative">
                            ...
                            <input 
                              ...
                              placeholder="0"
                              value={item.sale_price_per_m3 || ''}
                              onChange={(e) => updateItem(item.id, { sale_price_per_m3: Math.max(0, parseInt(e.target.value) || 0) })}
                            />
                          </div>
                          {selectedInv && (
                            <p className="text-[9px] text-emerald-600 dark:text-emerald-400 mt-1">Modal: {new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(selectedInv.avg_price)}</p>
                          )}
                        </div>
