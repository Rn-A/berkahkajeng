...
export default function CustomersView({ customers, onSave, onDelete }: CustomersViewProps) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Daftar Pelanggan</h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-xs md:text-sm">Kelola data pembeli tetap Anda.</p>
        </div>
        <button 
          onClick={handleAdd}
        ...
        <AnimatePresence mode="popLayout">
          {currentItems.map((customer) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-4">{customer.name}</h3>
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div>
                  <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest block mb-1">Nama Pelanggan</label>
                  <input 
                    required
                    type="text"
